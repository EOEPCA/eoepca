...
def main():
    ...
    ades_url_proc = ades_url_direct
    ades_token = ades_jwt_example

    # path prefix depending on endpoint
    ades_prefix = ""
    if ades_url_proc == ades_url:
        ades_prefix = "/ades"

    # Init ADES
    demo.set_ades_wps_url(ades_url_proc + ades_prefix + "/zoo")
    demo.set_ades_proc_url(ades_url_proc + ades_prefix + "/wps3")
