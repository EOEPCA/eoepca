...
[.text-center]
.Common Architecture Approach
image::eoepca-approach.png[width=70%,pdfwidth=70%,align="center"]
...
image::reference-impl.png[width=70%,pdfwidth=70%,align="center"]
...
[.text-center]
.PDE - Landing Page
image::pde-landing-page.png[width=70%,pdfwidth=70%,align="center"]

[.text-center]
.PDE - JupyterLab
image::pde-jupyter.png[width=70%,pdfwidth=70%,align="center"]
...
[.text-center]
.Workspace API
image::workspace-api.png[width=70%,pdfwidth=70%,align="center"]
...
[.text-center]
.Identity and Access Management (IAM)
image::iam.png[width=70%,pdfwidth=70%,align="center"]
